...
class ExploreTree extends PureComponent {
  ...
  componentDidMount(){
    request.get('http://dev.aps.zetyun.cn/aps/pipes/session/sso').then(jsonResponse => {
      console.log(jsonResponse, '登陆11');
    })
    request.get('http://dev.aps.zetyun.cn/aps/pipes/project/24bc702c-8244-42af-ab68-9c894ce4867c/notebook/module/treelist').then(jsonResponse => {
